...
// Current users list
let current_users = ["john", "emma", "alex", "sarah", "mike"];

// New users list
let new_users = ["emily", "alex", "chris", "MIKE", "sam"];


// Loop through new users to check for availability
for (let i = 0; i < new_users.length; i++) {
    let usernameTaken = false; // to track whether a username is taken already taken or not.
